...
class ProjectData {
  static const List<Project> featuredProjects = [
    Project(
      ...
      isFeatured: true,
      imagePaths: [
        'project_images/portal_app/image_0.jpeg',
        'project_images/portal_app/image_1.png',
        'project_images/portal_app/image_2.png',
      ],
    ...
    Project(
      ...
      isFeatured: true,
      imagePaths: [
        'project_images/dream_canvas/home_screen.png',
        'project_images/dream_canvas/home_screen2.png',
        'project_images/dream_canvas/setting_screen.png',
      ],
    ...
    Project(
      ...
      isFeatured: true,
      imagePaths: [
        'project_images/housely_real_estate_app/image_1.png',
        'project_images/housely_real_estate_app/image_2.png',
        'project_images/housely_real_estate_app/image_3.png',
      ],
